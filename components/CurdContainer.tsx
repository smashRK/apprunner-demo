...
const CurdContainer = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await fetch(`https://ms26anqgpc.ap-south-1.awsapprunner.com/api/users`);
    ...
    try {
      ...
      if (editIndex !== null) {
        ...
        response = await fetch(
          `https://ms26anqgpc.ap-south-1.awsapprunner.com/api/users/${products[editIndex].id}`,
          {
            method: "PUT",
            headers: {
        ...
        response = await fetch(`https://ms26anqgpc.ap-south-1.awsapprunner.com/api/users`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const handleDelete = async (id: number) => {
    try {
      setError(null);
      const response = await fetch(`https://ms26anqgpc.ap-south-1.awsapprunner.com/api/users/${id}`, {
        method: "DELETE",
      });
